...
} from "./engine.js?v=324";
import { Dictionary } from "./dictionary.js?v=324";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=324";
...
const BUILD_VERSION = "garenna-v324";
