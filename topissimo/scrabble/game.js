...
} from "./engine.js?v=268";
import { Dictionary } from "./dictionary.js?v=268";
import { findTop, findTopRanked, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=268";
...
const BUILD_VERSION = "garenna-v268";
