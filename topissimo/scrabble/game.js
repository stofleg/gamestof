...
} from "./engine.js?v=318";
import { Dictionary } from "./dictionary.js?v=318";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=318";
...
const BUILD_VERSION = "garenna-v318";
