...
} from "./engine.js?v=362";
import { Dictionary } from "./dictionary.js?v=362";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=362";
...
const BUILD_VERSION = "garenna-v362";
