...
} from "./engine.js?v=332";
import { Dictionary } from "./dictionary.js?v=332";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=332";
...
const BUILD_VERSION = "garenna-v332";
