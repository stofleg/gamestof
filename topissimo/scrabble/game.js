...
import { Dictionary } from "./dictionary.js?v=361";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=361";
...
const BUILD_VERSION = "garenna-v361";
