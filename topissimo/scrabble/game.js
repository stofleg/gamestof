...
} from "./engine.js?v=345";
import { Dictionary } from "./dictionary.js?v=345";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=345";
...
const BUILD_VERSION = "garenna-v345";
