...
} from "./engine.js?v=343";
import { Dictionary } from "./dictionary.js?v=343";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=343";
...
const BUILD_VERSION = "garenna-v343";
