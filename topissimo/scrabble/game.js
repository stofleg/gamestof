...
import { Dictionary } from "./dictionary.js?v=309";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=309";
...
const BUILD_VERSION = "garenna-v309";
