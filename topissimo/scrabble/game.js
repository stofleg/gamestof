...
} from "./engine.js?v=336";
import { Dictionary } from "./dictionary.js?v=336";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=336";
...
const BUILD_VERSION = "garenna-v336";
