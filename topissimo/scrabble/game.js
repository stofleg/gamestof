...
} from "./engine.js?v=346";
import { Dictionary } from "./dictionary.js?v=346";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=346";
...
const BUILD_VERSION = "garenna-v346";
