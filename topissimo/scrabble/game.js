...
} from "./engine.js?v=339";
import { Dictionary } from "./dictionary.js?v=339";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=339";
...
const BUILD_VERSION = "garenna-v339";
