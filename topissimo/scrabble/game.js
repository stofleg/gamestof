...
import { Dictionary } from "./dictionary.js?v=307";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=307";
...
const BUILD_VERSION = "garenna-v307";
