...
} from "./engine.js?v=342";
import { Dictionary } from "./dictionary.js?v=342";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=342";
...
const BUILD_VERSION = "garenna-v342";
