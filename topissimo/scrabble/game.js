...
} from "./engine.js?v=340";
import { Dictionary } from "./dictionary.js?v=340";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=340";
...
const BUILD_VERSION = "garenna-v340";
