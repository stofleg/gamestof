...
} from "./engine.js?v=356";
import { Dictionary } from "./dictionary.js?v=356";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=356";
...
const BUILD_VERSION = "garenna-v356";
