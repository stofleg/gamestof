...
import { Dictionary } from "./dictionary.js?v=304";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=304";
...
const BUILD_VERSION = "garenna-v304";
