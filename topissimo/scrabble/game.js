...
} from "./engine.js?v=354";
import { Dictionary } from "./dictionary.js?v=354";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=354";
...
const BUILD_VERSION = "garenna-v354";
