...
} from "./engine.js?v=341";
import { Dictionary } from "./dictionary.js?v=341";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=341";
...
const BUILD_VERSION = "garenna-v341";
