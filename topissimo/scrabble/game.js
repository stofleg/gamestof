...
import { Dictionary } from "./dictionary.js?v=308";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=308";
...
const BUILD_VERSION = "garenna-v308";
