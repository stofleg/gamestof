...
} from "./engine.js?v=367";
import { Dictionary } from "./dictionary.js?v=367";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=367";
...
const BUILD_VERSION = "garenna-v367";
