...
} from "./engine.js?v=344";
import { Dictionary } from "./dictionary.js?v=344";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=344";
...
const BUILD_VERSION = "garenna-v344";
