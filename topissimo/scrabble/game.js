...
import { Dictionary } from "./dictionary.js?v=310";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=310";
...
const BUILD_VERSION = "garenna-v310";
