...
} from "./engine.js?v=326";
import { Dictionary } from "./dictionary.js?v=326";
import { findTop, findTopRanked, rankIsotops, snakeBestTop, snakeMoveLegal } from "./topfinder.js?v=326";
...
const BUILD_VERSION = "garenna-v326";
