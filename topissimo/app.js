...
async function loadMyGames() {
  ...
  const { modeDisplayName } = await import("./scrabble/engine.js?v=232");
...
async function loadTournamentStats(tournamentId, games) {
  ...
  const { emptyBoard, applyMove, GAME_MODES } = await import("./scrabble/engine.js?v=232");
  const gameById = {};
...
$("#pgMode").addEventListener("change", async () => {
  const { GAME_MODES } = await import("./scrabble/engine.js?v=232");
  ...
  try {
    ...
    try {
      mods = await Promise.all([
        import("./scrabble/dictionary.js?v=232"),
        import("./scrabble/generator.js?v=232"),
      ]);
    } catch (e) {
...
window.recomputeAllNeg = async function(force = false) {
  ...
  let recomputeResult;
  try {
    ({ recomputeResult } = await import("./scrabble/recompute.js?v=232"));
  } catch (e) {
